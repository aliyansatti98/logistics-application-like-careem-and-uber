...
public class map8 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mpas8);
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent1 = new Intent(map8.this,essentialdeliveryitemsdetails.class);
...
*/
                ...
                Intent in = new Intent(map8.this,essentialdeliveryitemsdetails.class);
                in.putExtra("distance",rat);
                in.putExtra("dropoff",PlaceName);
                in.putExtra("pickup",pickup);
                startActivity(in);

                Toast.makeText(map8.this,"Distance "+ Math.round(rat) + "Km",Toast.LENGTH_LONG).show();
        ...
        gpsTracker = new GPSTracker(map8.this);

        // Eger konum bilgisi alinabiliyorsa ekranda goruntulenir
        if (gpsTracker.canGetLocation())
        {
            mapFragment.getMapAsync(map8.this);
...
// Create a new Places client instance.
        ...
        placesClient = Places.createClient(map8.this);
