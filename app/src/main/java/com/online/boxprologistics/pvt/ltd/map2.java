...
Intent intent1 = new Intent(map2.this,cramessengeractivity.class);
...
*/
   ...
   Intent in = new Intent(map2.this,cramessengeractivity.class);
     in.putExtra("distance",rat);
        in.putExtra("dropoff",PlaceName);
        in.putExtra("pickup",pickup);
        startActivity(in);

       Toast.makeText(map2.this,"Distance "+ Math.round(rat) + "Km",Toast.LENGTH_LONG).show();
        ...
        gpsTracker = new GPSTracker(map2.this);
...
// Create a new Places client instance.
        ...
        placesClient = Places.createClient(map2.this);
