...
public class maps7 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mpas7);
        btn1=findViewById(R.id.cconfirmpickup);
        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(maps7.this,map8.class);
        ...
        mapFragment.getMapAsync(maps7.this);
        gpsTracker = new GPSTracker(maps7.this);
...
// Create a new Places client instance.
        ...
        placesClient = Places.createClient(maps7.this);
