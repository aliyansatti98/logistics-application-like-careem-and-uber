...
public class map4Activity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent1 = new Intent(map4Activity.this,bikemessenger.class);
...
*/
               ...
               Intent in = new Intent(map4Activity.this,bikemessenger.class);
                ...
                Toast.makeText(map4Activity.this,"Distance "+ Math.round(rat) + "Km",Toast.LENGTH_LONG).show();
        ...
        gpsTracker = new GPSTracker(map4Activity.this);

        // Eger konum bilgisi alinabiliyorsa ekranda goruntulenir
        if (gpsTracker.canGetLocation())
        {
            mapFragment.getMapAsync(map4Activity.this);
...
// Create a new Places client instance.
        ...
        placesClient = Places.createClient(map4Activity.this);
